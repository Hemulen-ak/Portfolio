...
(function init() {
    ...
    function updateTuning(key, val) {
        ...
        if (img) {
            const tuning = getImageTuning(m);
            img.style.objectPosition = `${tuning.x}% ${tuning.y}%`;
